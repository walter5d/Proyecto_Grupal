    ...
    <section class="wrapper site-min-height">
        ...
        <div class="col-md-8 panel bg_container margin_top" id="prescription">
            ...
            <div class="bg_prescription">
                ...
                <div class="panel-body">
                    <div class="">
                        <h5 class="col-md-4 patient_name"><?php echo lang('patient'); ?>: <?php echo $patient->name; ?></h5>
                        <h5 class="col-md-2 patient"><?php echo lang('patient_id'); ?>: <?php echo $patient->id; ?></h5>
